...
<div class="land_img">
    <p id="kmk">
        <span class="text" style="color:#ff6131;">Khel</span> <span style="color:white;">Maha</span><span
        ...
        <div class="carousel-item active">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class="card-btn" id="card_btn"><a href="src/details.php#hockey">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class="card-btn" id="card_btn"><a href="src/details.php#badminton">View
                            Details</a></button>
                </div>
            </div>
            <!--3-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#running">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#basketball">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#kho-kho">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#volleyball">View
                            Details</a></button>
                </div>
            </div>
            <!--7-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#cycling">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#weight-lifting"> View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#kabaddi">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#chess">View
                            Details</a></button>
                </div>
            </div>
            <!--11-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#shootingball">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#yogasan">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#tugofwar">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#archery">View
                            Details</a></button>
                </div>
            </div>
            <!--15-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#football">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#handball">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#judo">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#wrestling">View
                            Details</a></button>
                </div>
            </div>
            <!--19-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#lawntennis">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#skating">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#swimming">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#tabletennis">View
                            Details</a></button>
                </div>
            </div>
            <!--23-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#taekwondo">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#gymnastic">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#shooting">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#skating(artistic)">View
                            Details</a></button>
                </div>
            </div>
            <!--27-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#boxing">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#fencing">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#karate">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#mallakhamb">View
                            Details</a></button>
                </div>
            </div>
            <!--31-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#horseriding">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#rugbyfootball">View
                            Details</a></button>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            ...
            <div class="card" id="e_card101">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#softtennis">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#sportclimbing">View
                            Details</a></button>
                </div>
            </div>
            <!--35-->
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#bridge">View
                            Details</a></button>
                </div>
            </div>
            ...
            <div class="card" id="e_card102">
                ...
                <div class="card-body">
                    ...
                    <button class=" card-btn" id="card_btn"><a href="src/details.php#rollball">View
                            Details</a></button>
                </div>
            </div>
        </div>
