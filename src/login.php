...
<div class="navbar navbar-expand-sm bg-dark ">
    <div class="container-fluid">
        ...
        <!--        dropdown btn-->
        <div class="dropdown" id="drop_btn" style="margin-right:80px;">
            <a class="btn  dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                Other
            </a>

            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="Institute_registration.html"><span class="d-item">Institute Registration</span></a></li>
                <li><a class="dropdown-item" href="Team_Register.html"><span class="d-item">Team Registration</span> </a></li>
                <li><a class="dropdown-item" href="Registration.html"><span class="d-item"> Individual Registration </span></a></li>
            </ul>
        </div>
    </div>
</div>
...
<div id="menu" class="offcanvas offcanvas-start bg-dark text-light d-flex flex-column text-center ">
    ...
    <div class="offcanvas-body">
        <ul class="navbar-nav menu-list">
            ...
            <li class="nav-item"><a href="Game_details.html" class="nav-link text-light menu-link " >Games</a></li>

            <li class="nav-item"><a href="Events.html" class="nav-link text-light menu-link">Events</a></li>
...
<!--login form-->
<div class="container-fluid my-3" style=" height:100%; width:60%;">
